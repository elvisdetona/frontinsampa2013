...
<footer id="contato" role="contentinfo">
	<div class="wrap">
		...
		<form id="form"  class="contato d-ib va-t" action="javascript:void(0);" method="post">
			...
			<!--<div class="inputs">
				<input type="text" name="name" id="" class="box required" placeholder="Nome" />
				<input type="email" name="email" id="" class="box required email" placeholder="E-mail" />			
			</div>
			<textarea name="message" id="" class="box textarea required" placeholder="Mensagem"></textarea>
			<div class="ta-c">
		...
		<div class="redes">
			<div class="follow d-ib">
				<strong>Acompanhe o Front In Sampa</strong> através das redes sociais: <a href="https://twitter.com/frontinsp" target="_blank" class="tw _s va-m">Twitter</a> <a href="https://www.facebook.com/frontinsampa" target="_blank" class="fb _s va-m">Facebook</a>
			</div>
			<div class="share">
